package com.uipep.bubbleshowcase
...
class MainActivity : AppCompatActivity() {
    ...
    private fun modification(){
        val builder : BubbleShowCaseBuilder = BubbleShowCaseBuilder(this)
        builder.title("Welcome!!!")
                .description("This is a simple BubbleShowCase with default values.")
                .targetView(buttonSimpleShowCase)
        val bubbleShowCase : BubbleShowCase = BubbleShowCase(builder)
        //val ll : LinearLayout =
        bubbleShowCase.show()
    ...
    private fun getListenerShowCaseBuilder(): BubbleShowCaseBuilder{
        return BubbleShowCaseBuilder(this)
                ...
                .listener(object : BubbleShowCaseListener {
                    ...
                    override fun onContinueBtnClick(bubbleShowCase: BubbleShowCase) {
                        Toast.makeText(this@MainActivity, "onContinueBtnClick", Toast.LENGTH_SHORT).show()
                    }

                    override fun onSkipBtnClick(bubbleShowCase: BubbleShowCase) {
                        Toast.makeText(this@MainActivity, "onSkipBtnClick", Toast.LENGTH_SHORT).show()

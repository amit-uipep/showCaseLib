...
class BubbleShowCase (builder: BubbleShowCaseBuilder){
    ...
    private val FOREGROUND_CONTINUE_BUTTON_ID = 732
    private val FOREGROUND_SKIP_BUTTON_ID = 733
    ...
    private var backgroundContinueBtn : Button? = null
    private var backgroundSkipBtn : TextView? = null
    ...
    private fun getBackgroundDimLayout(): RelativeLayout {
        ...
        val continueBtn = Button (mActivity.get()!!)
        val skipBtn = TextView (mActivity.get()!!)

        val btnLayout  = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,ViewGroup.LayoutParams.WRAP_CONTENT)
        skipBtn.id = FOREGROUND_SKIP_BUTTON_ID

        val continueBtnLayoutParams  = RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,ViewGroup.LayoutParams.WRAP_CONTENT)
        continueBtn.id = FOREGROUND_CONTINUE_BUTTON_ID

        //btnLayout.addRule(RelativeLayout.RIGHT_OF,continueBtn.id)
        ...
        continueBtnLayoutParams.addRule(RelativeLayout.ALIGN_PARENT_LEFT)
